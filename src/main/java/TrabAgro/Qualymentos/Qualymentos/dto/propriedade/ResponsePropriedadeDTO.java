...
public record ResponsePropriedadeDTO(Long id, String nome, String codigoRural, String areaTotal, String municipio,
        String estado, String tipoSolo, String tipoProducao, String tipoCultura) {
